    ...
    try:
        with open(config_path, "r") as f:
            try:
                ...
                print("[\033[94mgiangvlcs\033[0m]: Invalid config. Loading defaults...")
    except:
        print("[\033[94mgiangvlcs\033[0m]: Couldn't open config. Loading defaults...")
else:
    first_run = True
